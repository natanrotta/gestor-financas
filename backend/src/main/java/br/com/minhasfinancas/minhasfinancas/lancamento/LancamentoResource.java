...
import br.com.minhasfinancas.minhasfinancas.lancamento.dto.AtualizaStatusDTO;
import br.com.minhasfinancas.minhasfinancas.lancamento.dto.LancamentoDTO;
...
public class LancamentoResource {
    ...
    private Lancamento converter(LancamentoDTO dto) {
        ...
        Usuario usuario = usuarioService.obterPorId(dto.getUsuario())
                .orElseThrow(() -> new RegraNegocios("Usuário não encontrado para o Id informado!"));
